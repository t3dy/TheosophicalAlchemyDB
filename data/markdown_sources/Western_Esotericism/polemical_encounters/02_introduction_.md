...
section_number: 2
date_processed: 2026-05-25T15:26:00.603568
...
con(cid:2) ict. This volume deals with a speci(cid:3) c subset of such responses, as
...
polemics addressed by adherents of speci(cid:3) c esoteric currents at those
...
an audience—which can be (cid:3) ctitious, to be sure—that offers support
...
rents of thought that present either innovative syntheses of these in(cid:2) uences or original
formulations with an air of family resemblance. There are several, only partly com-
patible attempts to de(cid:3) ne this corpus of currents with greater theoretical rigor; for a
...
[Page 9]
viii olav hammer and kocku von stuckrad
...
to polemics defensively and in an attempt at justi(cid:3) cation. The two
...
falsi(cid:3) ed their own scriptures.6
3 Interestingly, literature dealing speci(cid:3) cally with religious polemics is quite limited;
